$(document).ready(function() {
	...
	var apiRoot = 'https://mighty-ridge-59808.herokuapp.com/v1/task/';
	...
	function createElement(data) {
		var element = $(datableRowTemplate).clone();
	...
	function handleDatableRender(data) {
		taskContainer.empty();
		data.forEach(function(task) {
			createElement(task).appendTo(taskContainer);
		});
	}
